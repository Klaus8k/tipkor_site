...
class MetaPoly(models.Model):
    ...
    def __str__(self) -> str:
        ...
        if self.duplex:
            duplex = '4+4'
        return '{}x{}, {}, {}, {}шт - {}руб'.format(self.x, self.y, self.paper, duplex, self.pressrun, self.cost)
...
class Cards(MetaPoly):
    ...
    paper = models.CharField(choices=[('300', '300 г/м')], default='300', max_length=20, help_text='Плотность бумаги')
