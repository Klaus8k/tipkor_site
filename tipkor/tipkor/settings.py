"""
Django settings for tipkor project.
...
CSRF_TRUSTED_ORIGINS = ['https://*.tipkor.com','https://*.79.133.181.123']
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            BASE_DIR / 'stamp/templates/stamp', # path to templates files
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'tipkor.wsgi.application'
